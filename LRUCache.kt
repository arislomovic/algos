object LRUCache : Problem.Medium(146) {
    ...
    internal data class LRUCache(private val capacity: Int) :
        LinkedHashMap<Int, Int>(capacity, DEFAULT_LOAD_FACTOR, true) {
    ...
    internal data class LRUCache2(private val capacity: Int) : LinkedHashMap<Int, Int>() {
        override fun get(key: Int) = getOrDefault(key, -1).also { this[key] = it }
